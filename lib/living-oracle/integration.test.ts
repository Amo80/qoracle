...
describe("Living Oracle integration contracts", () => {
  ...
  it("exposes an accessible status and decorative-only atmosphere", () => {
    expect(layerSource).toContain('aria-live={jesterIntelligencePending || loveIntelligencePending || dungeonIntelligencePending || chaosIntelligencePending || eclipseIntelligencePending ? "off" : "polite"}');
